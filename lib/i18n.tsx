...
const messages = {
  en: {
    ...
    contact: { title: "Let's talk", intro: "Tell me about your project", socials: "Social profiles", name: "Name", email: "Email", description: "Description", send: "Send", sending: "Sending…", success: "Thanks! Your message has been sent.", error: "Something went wrong. Please try again.", unconfigured: "The contact form is not configured yet." },
  ...
  es: {
    ...
    contact: { title: "Hablemos", intro: "Cuéntame sobre tu proyecto", socials: "Perfiles sociales", name: "Nombre", email: "Email", description: "Descripción", send: "Enviar", sending: "Enviando…", success: "¡Gracias! Tu mensaje se ha enviado.", error: "Algo ha fallado. Inténtalo de nuevo.", unconfigured: "El formulario de contacto aún no está configurado." },
